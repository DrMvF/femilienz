...
const socials = [
  {
    ...
    label: "LinkedIn",
    handle: "miriamvonfelbert",
  },
  {
    icon: <Mail size={20} />,
    href: "mailto:mvf@femilienz.de",
    label: "Email",
    handle: "mvf@femilienz.de",
  },
  {
          ...
          {socials.map((s) => (
            <Card key={s.href}>
              <Link
                href={s.href}
                target="_blank"
                className="p-4 no-underline relative flex flex-col items-center gap-4 duration-700 group md:gap-8 md:py-24 lg:pb-48 md:p-16"
              >
                <span
